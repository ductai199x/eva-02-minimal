...
def batched_soft_nms(boxes, scores, idxs, method, gaussian_sigma, linear_threshold, prune_threshold):
    """
    ...
    return soft_nms(boxes_for_nms, scores, method, gaussian_sigma, linear_threshold, prune_threshold)
