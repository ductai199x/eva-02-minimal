...
from ..box.box_regression import _dense_box_regression_loss
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(input_shape, int):  # some backward compatibility
            input_shape = {"channels": input_shape}
        ...
        if self.use_fed_loss:
            raise NotImplementedError("Federated loss is not implemented yet")
