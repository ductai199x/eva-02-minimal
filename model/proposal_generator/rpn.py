...
from .utils import find_top_rpn_proposals, subsample_labels
from .matcher import Matcher
from ..box.box_regression import Box2BoxTransform, _dense_box_regression_loss
from ..structures import Boxes, Instances, ImageList, pairwise_iou
from typing import *
...
class RPN(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        """
        Args:
            in_features (list[str]): list of names of input features to use (i.e. ["p2", "p3", "p4", "p5", "p6"])
